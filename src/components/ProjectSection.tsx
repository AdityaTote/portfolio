  ...
  return (
    <section className="py-32 px-6 relative bg-[#0a0f0d]">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {web2Projects.length > 0 && renderProjects(web2Projects, "Web2")}
        {web3Projects.length > 0 && renderProjects(web3Projects, "Web3")}
      </div>
    </section>
  );
};
...
const renderProjects = (projectList: Project[], category: string) => (
  <div className="mb-20">
    ...
    <div
      className="overflow-x-auto overflow-y-visible pb-8 -mx-6 px-6 cursor-grab active:cursor-grabbing"
